...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Add New Trader.</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						</button>
					</div>
					<div class="modal-body">
						<!--begin::Form-->
						<form class="kt-form" action="{{route('traders.store')}}" method="post">
							@csrf
							<div class="kt-portlet__body">
								...
								<div class="form-group">
									...
									<select class="form-control" name="bank_type" id="bank_type">
										...
										<option value="LANKBANK">LANKBANK</option>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="kt-form" action="{{route('traders.store')}}" method="post">
							@csrf
							<div class="kt-portlet__body">
								<input type="hidden" name="trader_id" id="trader_id_edit">
								<div class="form-group form-group-last">
									<div class="alert alert-secondary" role="alert">
										<div class="alert-icon"><i class="flaticon-warning kt-font-brand"></i></div>
										<div class="alert-text">
		...
		<script src="./assets/js/demo1/pages/crud/datatables/data-sources/traders.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
