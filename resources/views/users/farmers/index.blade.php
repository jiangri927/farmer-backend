	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
                                        ...
                                        {{--<tbody>--}}
                                            {{--@foreach($farmers as $farmer)--}}
                                                {{--<tr>--}}
                                                    ...
                                                    {{--<td>{{$farmer->city}}</td>--}}
                                                    {{--<td>{{$farmer->bank_type}}</td>--}}
                                                    {{--<td>{{$farmer->agriculture_category}}</td>--}}
                                                    {{--<td></td>--}}
                                                {{--</tr>--}}
                                                {{--@endforeach--}}
                                        {{--</tbody>--}}
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<!--begin::Form-->
						<form class="kt-form" action="{{route('farmers.store')}}" method="post">
							@csrf
							<div class="kt-portlet__body">
								...
								<div class="form-group">
									<label>Agriculture Category</label>
									<select class="form-control" name="agriculture_category" id="agriculture_category">
		...
		<div class="modal fade" id="kt_modal_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Edit Farmer Data.</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						</button>
					</div>
					<div class="modal-body">
						...
						<form class="kt-form" action="{{route('farmers.store')}}" method="post">
							...
							<div class="kt-portlet__body">
								...
								<div class="form-group">
									<label>Agriculture Category</label>
									<select class="form-control" name="agriculture_category" id="agriculture_category_edit">
										<option value="Vegetables">Vegetables</option>
										<option value="Poultry">Poultry</option>
										<option value="3">Pig Farming</option>
										<option value="Pig Farming">Livestock</option>
										<option value="Crops">Crops</option>
										<option value="Aquaculture">Aquaculture</option>
										<option value="Dairy Farming">Dairy Farming</option>
									</select>
		...
		<script src="./assets/js/demo1/pages/crud/datatables/data-sources/javascript.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
