...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!--begin::Form-->
                                    <form class="kt-form" action="{{route('goods.store',['user_id'=>Auth::user()->id])}}" method="post">
                                        @csrf
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="form-group">
                                                <label>Ani</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter ani" name="ani" id="ani">
                                            </div>
                                            <div class="form-group">
                                                <label>Category</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter category" name="category" id="category">
                                            </div>
                                            <div class="form-group">
                                                <label>SBP</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter SBP" name="sbp" id="sbp">
                                            </div>
                                            <div class="form-group">
                                                <label>SP</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter SP" name="sp" id="sp">
                                            </div>
                                            <div class="form-group">
                                                <label>ATP</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter ATP" name="atp" id="atp">
                                            </div>
                    ...
                    <div class="modal fade" id="kt_modal_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit Goods data</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    </button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <form class="kt-form" action="{{route('goods.store',['user_id'=>Auth::user()->id])}}" method="post">
                                        ...
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="form-group">
                                                <label>Ani</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter ani" name="ani" id="ani_edit">
                                            </div>
                                            <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter ani" name="product_id" id="product_id" hidden>

                                            <div class="form-group">
                                                <label>Category</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter category" name="category" id="category_edit">
                                            </div>
                                            <div class="form-group">
                                                <label>SBP</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter SBP" name="sbp" id="sbp_edit">
                                            </div>
                                            <div class="form-group">
                                                <label>SP</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter SP" name="sp" id="sp_edit">
                                            </div>
                                            <div class="form-group">
                                                <label>ATP</label>
                                                <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter ATP" name="atp" id="atp_edit">
                                            </div>
		...
		<script src="./assets/js/demo1/pages/crud/datatables/data-sources/goods.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
