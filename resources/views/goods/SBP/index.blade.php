...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<!--begin::Form-->
						<form class="kt-form" action="{{route('SBP.store')}}" method="post">
							@csrf
							<div class="kt-portlet__body">
								...
								<div class="form-group">
									...
									<select class="form-control" name="category" id="category">
										...
										<option value="7">Dairy Farming</option>
									</select>
								</div>
								<div class="form-group">
									<label>Price</label>
									<input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter Price" name="price" id="price">
								</div>
							</div>
					...
					<div class="modal-body">
						...
						<form class="kt-form" action="{{route('SBP.store')}}" method="post">
							...
							<div class="kt-portlet__body">
								...
								<div class="form-group">
									<label>Price</label>
									<input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter Price" name="price" id="price_edit">
								</div>
							</div>
							<div class="kt-portlet__foot">
								<div class="kt-form__actions">
		...
		<script src="./assets/js/demo1/pages/crud/datatables/data-sources/sbp.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
